...
- The product image or product itself can appear with a clear, memorable action or close-up within a 25-30 second script.
...
3. Parameter and visual calibration:
   ...
   - Duration control: target a 30-second script. Minor fluctuation is allowed only when preserving the original hotspot rhythm, but the final script should stay within 25-30 seconds.
...
- Total video duration should be 25-30 seconds, with 30 seconds as the default target.

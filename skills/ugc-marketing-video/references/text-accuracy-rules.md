...
For SD2.0 stability, use short text elements:
...
- CTA text appears in 12-15s with product or phone entrance visible
...
- Show one authoritative screenshot or page plane per shot on one phone, tablet, laptop, or single picture-in-picture panel.
- Keep one page readable in the frame; use sequential shots for multiple pages.
- Keep screenshot text stable and readable by limiting camera movement.
- Let the creator raise the device from a visible resting position with wrist and forearm connected, then hold the screen at a readable angle.
